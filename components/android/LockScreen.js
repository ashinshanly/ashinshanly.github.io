    ...
    return (
        ...
        >
            ...
            <div className="lock-notifications" style={{ opacity: opac, transform: `translateY(${Math.min(0, currentY / 3)}px)` }}>
                {/* Notification 1: GitHub */}
                <div className="glass-notification">
                    <div className="glass-notification-header">
                        ...
                        <span className="glass-notification-title">GitHub</span>
                        <span className="glass-notification-time">2m</span>
                    </div>
                    <div className="glass-notification-content">
                        <strong>Linus Torvalds</strong> starred your repository <strong>portfolio</strong>
                    </div>
                </div>

                {/* Notification 2: LinkedIn */}
                <div className="glass-notification">
                    <div className="glass-notification-header">
                        ...
                        <span className="glass-notification-title">LinkedIn</span>
