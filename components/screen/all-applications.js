...
export class AllApplications extends React.Component {
    ...
    render() {
        return (
            <div className={"absolute h-full top-7 w-full z-20 md:pl-12 pl-0 pb-16 md:pb-0 justify-center md:pl-20 border-black border-opacity-60 bg-black bg-opacity-70"}>
                <div className={"flex md:pr-20 pt-5 align-center justify-center px-4 md:px-0"}>
                    <div className={"flex w-full h-full items-center pl-2 pr-2 bg-white border-black border-width-2 rounded-xl overflow-hidden md:w-1/3 "}>
                ...
                <div className={"grid md:grid-cols-6 md:grid-rows-3 grid-cols-4 grid-rows-5 md:gap-4 gap-2 md:px-20 px-4 pt-6 md:pt-10 justify-center overflow-y-auto"} style={{ maxHeight: 'calc(100% - 120px)' }}>
                    {this.renderApps()}
                </div>
                <div className={"flex align-center justify-center w-full fixed bottom-12 md:bottom-0 mb-15 md:pr-20 "}>
