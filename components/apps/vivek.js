        ...
        return (
            <>
                ...
                <div id="education" tabIndex="0" onFocus={this.changeScreen} className={(this.state.active_screen === "education" ? " bg-ub-orange bg-opacity-100 hover:bg-opacity-95" : " hover:bg-gray-50 hover:bg-opacity-5 ") + " w-28 md:w-full md:rounded-none rounded-sm cursor-default outline-none py-1.5 focus:outline-none duration-100 my-0.5 flex justify-start items-center pl-2 md:pl-2.5"}>
                    <img className=" w-3 md:w-4" alt="ashin' education" src="./themes/Yaru/status/education.svg" />
                    <span className=" ml-1 md:ml-2 text-gray-50 ">Education</span>
                </div>
                <div id="skills" tabIndex="0" onFocus={this.changeScreen} className={(this.state.active_screen === "skills" ? " bg-ub-orange bg-opacity-100 hover:bg-opacity-95" : " hover:bg-gray-50 hover:bg-opacity-5 ") + " w-28 md:w-full md:rounded-none rounded-sm cursor-default outline-none py-1.5 focus:outline-none duration-100 my-0.5 flex justify-start items-center pl-2 md:pl-2.5"}>
                    <img className=" w-3 md:w-4" alt="ashin' skills" src="./themes/Yaru/status/skills.svg" />
                    <span className=" ml-1 md:ml-2 text-gray-50 ">Skills</span>
                </div>
                <div id="projects" tabIndex="0" onFocus={this.changeScreen} className={(this.state.active_screen === "projects" ? " bg-ub-orange bg-opacity-100 hover:bg-opacity-95" : " hover:bg-gray-50 hover:bg-opacity-5 ") + " w-28 md:w-full md:rounded-none rounded-sm cursor-default outline-none py-1.5 focus:outline-none duration-100 my-0.5 flex justify-start items-center pl-2 md:pl-2.5"}>
                    <img className=" w-3 md:w-4" alt="ashin' projects" src="./themes/Yaru/status/projects.svg" />
                ...
                <div className='my-0.5 w-28 md:w-full h-8 px-2 md:px-2.5 flex' >
                    <iframe src="https://github.com/sponsors/ashinshanly/button" title="Sponsor ashinshanly" width={"100%"} height={"100%"} ></iframe>
                </div>
            </>
        );
    }
    ...
    return (
        <>
            ...
            <ul className=" mt-4 leading-tight tracking-tight text-sm md:text-base w-5/6 md:w-3/4 emoji-list">
                <li className=" list-pc">I'm a <span className=" font-medium">Software Engineer</span> currently pursuing Computer Science. with a Master's in Technology in Computer Science and Engineering, proficient in cloud platforms, machine learning, and data engineering, with a focus on creating scalable, high-performance solutions. Adept at leveraging technical expertise and leadership to enhance business decision-making, drive system efficiency, and innovate in cloud-based architectures. Seeking opportunities to apply my skills and contribute to transformative projects in cutting-edge technology environments! ( Hit me up <a className='text-underline' href='mailto:ashinkoottala@gmail.com'><u>@ashinkoottala@gmail.com</u></a> :) )</li>
...
function Projects() {
    const project_list = [
        {
            ...
            date: "Apr 2021",
            link: "https://github.com/ashinshanly/ashinshanly.github.io",
            description: [
        ...
        },
        {
            ...
            date: "Dec 2021",
            link: "https://github.com/ashinshanly/chrome-extension-react-boilerplate",
            description: [
        ...
        },
        {
            name: "CodeConnect",
            date: "Nov 2021",
            link: "https://github.com/ashinshanly/CodeConnect-frontend",
            description: [
        ...
        },
        {
            ...
            date: "Jun 2021",
            link: "https://github.com/ashinshanly/ad-free-spotify",
            description: [
        ...
        },
        {
            ...
            date: "Mar 2021",
            link: "https://github.com/ashinshanly/economist.com-unlocked",
            description: [
        ...
        },
        {
            ...
            date: "Jan 2021",
            link: "https://github.com/ashinshanly/flutter-banking-app",
            description: [
        ...
        },
        {
            ...
            date: "Dec 2020",
            link: "https://github.com/ashinshanly/CPU-Scheduling-APP-React-Native",
            description: [
        ...
        },
        {
            ...
            date: "Nov 2020",
            link: "https://github.com/ashinshanly/Meditech-Healthcare",
            description: [
        ...
        },
        {
            ...
            date: "Sep 2020",
            link: "https://github.com/ashinshanly/Improve-Codeforces",
            description: [
    ...
    return (
        <>
            ...
            <iframe src="https://github.com/sponsors/ashinshanly/card" title="Sponsor ashinshanly" className='my-4 w-5/6 md:w-3/4' ></iframe>
