...
export function VisitorStats() {
    ...
    const StatCard = ({ label, value, color, icon }) => (
        <div className="flex flex-col items-center justify-center p-5 md:p-6 bg-gray-900 bg-opacity-40 rounded-2xl border border-gray-700 backdrop-blur-md transform transition-all hover:scale-105 hover:bg-opacity-60 group">
            <div className={`text-3xl md:text-4xl mb-4 ${color} group-hover:scale-110 transition-transform duration-300`}>
                {icon}
            </div>
            <div className="text-sm font-medium text-gray-400 uppercase tracking-widest mb-2">{label}</div>
            <div className="text-4xl md:text-5xl font-bold text-white tabular-nums tracking-tighter animate-pulse-subtle">
    ...
    return (
        <div className="w-full h-full overflow-y-auto bg-gradient-to-br from-gray-900 via-ub-grey to-gray-800 text-white select-none">
            <div className="w-full min-h-full flex flex-col items-center justify-start md:justify-center p-4 md:p-8">
                <div className="max-w-4xl w-full">
                    <header className="text-center mb-8 md:mb-12">
                        <h1 className="text-3xl md:text-4xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-500 mb-2">
                            Portfolio Insights
                        </h1>
                        ...
                        <div className="mt-12 w-full animate-fade-in">
                            ...
                            <div className="space-y-3">
                                {recentViewers.map((viewer, idx) => (
                                    <div key={idx} className="flex items-center justify-between p-3 md:p-4 bg-gray-800 bg-opacity-30 rounded-xl border border-gray-700 hover:bg-opacity-50 transition-all">
