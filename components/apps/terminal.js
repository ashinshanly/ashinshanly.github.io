...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            ...
            projects: ["Accelerated Implicit Neural Representation with Split Encoder and Multiscale Partitioning", "Image Caption Generator using Siamese Graph Convolutional Networks and LSTM", "Reverse Dictionary using an Improved CBOW model", "Sign-Language-Translator", "WheresMyTicket"],
            interests: ["Software Engineering", "Deep Learning", "Computer Vision"],
            languages: ["Python", "C/C++", "Java", "Javascript", "Terraform"],
        };
        this.state = {
            terminal: [],
        }
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">ashin@macos</div>
    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {
            ...
            case "pwd":
                ...
                result = str.replace("~", "/home/ashin")
                break;
            case "code":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("vscode");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-ashin, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
            ...
            case "about-ashin":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("about-ashin");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-ashin, todoist, trash, settings, sendmsg ]";
                }
                break;
